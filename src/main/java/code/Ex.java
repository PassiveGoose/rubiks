...
public class Ex extends Application {
    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
        ...
        System.out.println(getClass().getResourceAsStream("E:\\project\\rubiksCube\\src\\main\\java\\code\\palette.png"));
        mat.setDiffuseMap(new Image(new FileInputStream(new File("E:\\project\\rubiksCube\\src\\main\\java\\code\\palette.png"))));
    ...
    private static final Point3D pFLD   = new Point3D(-1.0,  1.0, -1.0);
    private static final Point3D pFD    = new Point3D(   0,  1.0, -1.0);
    private static final Point3D pFRD   = new Point3D( 1.0,  1.0, -1.0);
    private static final Point3D pFL    = new Point3D(-1.0,    0, -1.0);
    private static final Point3D pF     = new Point3D(   0,    0, -1.0);
    private static final Point3D pFR    = new Point3D( 1.0,    0, -1.0);
    private static final Point3D pFLU   = new Point3D(-1.0, -1.0, -1.0);
    private static final Point3D pFU    = new Point3D(   0, -1.0, -1.0);
    private static final Point3D pFRU   = new Point3D( 1.0, -1.0, -1.0);
    ...
    private static final Point3D pCLD   = new Point3D(-1.0,  1.0, 0);
    private static final Point3D pCD    = new Point3D(   0,  1.0, 0);
    private static final Point3D pCRD   = new Point3D( 1.0,  1.0, 0);
    private static final Point3D pCL    = new Point3D(-1.0,    0, 0);
    private static final Point3D pC     = new Point3D(   0,    0, 0);
    private static final Point3D pCR    = new Point3D( 1.0,    0, 0);
    private static final Point3D pCLU   = new Point3D(-1.0, -1.0, 0);
    private static final Point3D pCU    = new Point3D(   0, -1.0, 0);
    private static final Point3D pCRU   = new Point3D( 1.0, -1.0, 0);
    ...
    private static final Point3D pBLD   = new Point3D(-1.0,  1.0, 1.0);
    private static final Point3D pBD    = new Point3D(   0,  1.0, 1.0);
    private static final Point3D pBRD   = new Point3D( 1.0,  1.0, 1.0);
    private static final Point3D pBL    = new Point3D(-1.0,    0, 1.0);
    private static final Point3D pB     = new Point3D(   0,    0, 1.0);
    private static final Point3D pBR    = new Point3D( 1.0,   0, 1.0);
    private static final Point3D pBLU   = new Point3D(-1.0, -1., 1.0);
    private static final Point3D pBU    = new Point3D(   0, -1.0, 1.0);
    private static final Point3D pBRU   = new Point3D( 1.0, -1.0, 1.0);
